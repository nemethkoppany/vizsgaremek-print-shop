            ...
            <div className="arlista-inner">
                ...
                <table className="price-table">
                    <tbody>
                        <tr>
                            <td colSpan="2">
                                <span className="service-name">Egyoldalas A/4 fekete-fehér nyomtatás és fénymásolás:</span>
                        ...
                        <tr>
                            <td colSpan="2">
                                <span className="service-name">Kétoldalas A/4 fekete-fehér nyomtatás és fénymásolás:</span>
                        ...
                        <tr>
                            <td colSpan="2">
                                <span className="service-name">Nyomtatás A/3 fekete-fehér (egyoldalas):</span>
                        ...
                        <tr>
                            <td colSpan="2">
                                <span className="service-name">Nyomtatás A/3 fekete-fehér (kétoldalas):</span>
                        ...
                        <tr>
                            <td colSpan="2">
                                <span className="service-name">Egyoldalas A/4 színes nyomtatás és fénymásolás:</span>
                        ...
                        <tr>
                            <td colSpan="2">
                                <span className="service-name">Kétoldalas A/4 színes nyomtatás és fénymásolás:</span>
                        ...
                        <tr>
                            <td colSpan="2">
                                <span className="service-name">Egyoldalas A/3 színes nyomtatás és fénymásolás:</span>
                        ...
                        <tr>
                            <td colSpan="2">
                                <span className="service-name">Kétoldalas A/3 színes nyomtatás és fénymásolás:</span>
